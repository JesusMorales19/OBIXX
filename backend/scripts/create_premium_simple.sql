-- ================================================
-- SCRIPT SIMPLIFICADO PARA FUNCIONALIDAD PREMIUM
-- Normalización 4FN (Cuarta Forma Normal)
-- ================================================
-- Funcionalidades Premium:
-- 1. Registro de horas laborales por trabajador
-- 2. Presupuesto en trabajos de largo plazo
...
-- Agregar campo presupuesto (solo para premium)
-- ================================================
ALTER TABLE trabajos_largo_plazo
ADD COLUMN IF NOT EXISTS presupuesto NUMERIC(12, 2) CHECK (presupuesto IS NULL OR presupuesto >= 0);
...
CREATE TABLE IF NOT EXISTS nominas_generadas (
    ...
    -- detalle_trabajadores estructura:
    -- [
    --   {
    --     "email_trabajador": "trabajador@email.com",
    --     "nombre": "Juan Pérez",
    --     "horas_trabajadas": 48,
    ...
    CONSTRAINT ck_nomina_saldo CHECK (saldo_restante = presupuesto_total - total_pagado_trabajadores)
);
