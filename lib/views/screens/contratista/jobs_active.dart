                        ...
                        children: _filteredJobs.map((job) {
                          if (job['type'] == 'largo') {
                            ...
                            return JobCardLargo(
                              ...
                              vacantesDisponiblesInt: (job['vacantesInt'] is int ? job['vacantesInt'] as int : int.tryParse(job['vacantesInt']?.toString() ?? '') ?? 0),
                              tipoObra: job['tipoObra'] ?? '',
                              fechaInicio: job['fechaInicio'] ?? '',
                              fechaFinal: job['fechaFinal'] ?? '',
                              latitud: job['latitud'] is double ? job['latitud'] as double : (job['latitud'] != null ? double.tryParse(job['latitud'].toString()) : null),
                              longitud: job['longitud'] is double ? job['longitud'] as double : (job['longitud'] != null ? double.tryParse(job['longitud'].toString()) : null),
